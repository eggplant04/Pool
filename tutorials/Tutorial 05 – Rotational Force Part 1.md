...
in order to use our m_angularVelocity we need to make sure we set it's value to 0 in the Rigidbody's constructors, otherwise our collisions will not work as intended.
